...
- Platform Independence - written on three different operating systems (Windows, Ubuntu, MacOS X) and two different IDEs, it is safe to say, that it will work on multiple platforms, flawlessly.
